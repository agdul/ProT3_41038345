                ...
                <?php foreach ($users as $user) : ?>
                    <tr class="text-center">
                        ...
                        <td class="align-middle">
                            ...
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="<?= $user->id_user; ?>" data-name="<?= $user->nombre_user ?>" data-nick="<?= $user->nombre_usuario ?>">
                                Eliminar
                            </button>
                        </td>
